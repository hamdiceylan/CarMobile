(function() {
    ...
    function createChild(collectionName,parentId) {
      var collection = $firebaseArray(firebaseDb.child(collectionName).child(parentId));
      ...
      function updateItem(item, updatedItem) {
        return firebaseDb.child(collectionName).child(item).child('answers').push(updatedItem);
      }
